...
export default function PublicApplyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#eef3fb] px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="rounded-[28px] border border-slate-200 bg-white shadow-[0_20px_80px_rgba(15,23,42,0.12)]">
          <div className="rounded-t-[28px] border-b border-slate-200 bg-[linear-gradient(135deg,#eef4ff_0%,#ffffff_55%,#f8fbff_100%)] px-6 py-6 sm:px-8">
            ...
            <form onSubmit={submit} className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6">
              ...
              <label className="text-sm">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none file:mr-3 file:rounded-lg file:border-0 file:bg-accent file:px-3 file:py-2 file:text-sm file:font-semibold file:text-white"
                />
              </label>
              ...
              <button
                ...
                className="inline-flex rounded-xl bg-accent px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
